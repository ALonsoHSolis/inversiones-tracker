  ...
  return (
    <main className="max-w-[1160px] mx-auto px-6 pt-[26px] pb-16">
      ...
      <div className="max-w-[720px]">
        <h1 className="text-[28px] font-semibold tracking-[-0.02em] text-[#F2F5F9]">Política de privacidad</h1>
        ...
        <ul className="mt-2 flex flex-col gap-1.5 text-[13.5px] text-[#97A2B4] leading-relaxed list-disc pl-5">
          <li>
