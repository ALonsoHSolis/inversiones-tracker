  ...
  return (
    <main className="max-w-[1160px] mx-auto px-6 pt-[26px] pb-16">
      ...
      <div className="max-w-[720px]">
        <h1 className="text-[28px] font-semibold tracking-[-0.02em] text-[#F2F5F9]">Términos y condiciones</h1>
        ...
        <nav className="flex items-center gap-4 mt-4">
          ...
          <Link href="/disclaimer" className={`${legalNavClass} text-[#8892A0]`}>
            disclaimer
          </Link>
        </nav>

        <p className="mt-6 text-[13.5px] text-[#97A2B4] leading-relaxed">
        ...
        <p className="text-[13.5px] text-[#97A2B4] leading-relaxed">
          ...
          <Link href="/disclaimer" className="text-[#C7CDD6] border-b border-white/[0.2]">
            disclaimer
          </Link>{" "}
        ...
        <p className="text-[13.5px] text-[#97A2B4] leading-relaxed">
          ...
          <FeedbackLink className="text-[#C7CDD6] border-b border-white/[0.2]">alonso.hsolis@gmail.com</FeedbackLink>. Nos
